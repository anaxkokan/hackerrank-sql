...
- [Weather Observation Station 5](https://www.hackerrank.com/challenges/weather-observation-station-5/submissions/code/204340890) - [weather_observation_station_5.sql](weather_observation_station_5.sql)

### 2021-03-14

- [Select All](https://www.hackerrank.com/challenges/select-all-sql/problem) - [select_all_sql.sql](select_all_sql.sql)
- [Select By ID](https://www.hackerrank.com/challenges/select-by-id/problem) - [select_by_id.sql](select_by_id.sql)
